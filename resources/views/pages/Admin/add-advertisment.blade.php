            ...
            <div class="col-md-6 student-profile"> 
                    <div id="change-password-container" >
                        {{-- <div class="form-group">
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="standard" class="form-check-label">Mentor Type</label>
                                </div>
                                <div class="col-md-9">
                                    <select required class="form-select form-control" name="mentor_type" id="mentor_type" aria-label="Default select example">
                                        <option value="">---- Select StatusType ----</option>
                                        <option value="0" {{ 0 == Auth::user()->status  ? 'selected' : ''}}>Active</option>
                                        <option value="1" {{ 1 == Auth::user()->status  ? 'selected' : ''}}>InActive </option>
