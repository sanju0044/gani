    ...
    <div class="row">
        <div class="col-md-3 col-xs-2 col-sm-2 col-lg-3 profile-image-wrapper">
            <div class="profile-wrapper">
                <div class="profile-image-wrapper text-center">
                    <img src="{{asset('public/images/25boss4r210_fjpalm_1.png')}}" width="100" height="100">
                </div>
        ...
        <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6 second-section-wrapper">
            ...
            <div class="profile-content-section">
                ...
                <div class="row">
                    <img src="{{asset('public/images/25boss4r210_fjpalm_1.png')}}" height="350" style="width:100%">
                </div>
                ...
                <div class="row user-comment-wrapper">
                    <div class="user-comment-section col-md-1">
                        <img src="{{asset('public/images/25boss4r210_fjpalm_1.png')}}" width="50" height="50">
                    </div>
                ...
                <div class="row user-comment-wrapper">
                    <div class="user-comment-section col-md-1">
                        <img src="{{asset('public/images/25boss4r210_fjpalm_1.png')}}" width="45" height="45">
                    </div>
                    <div class="col-md-10 comment-text section">
                        <div>
                            <span>
        ...
        <div class="col-md-3 col-xs-4 col-sm-4 col-lg-3 third-section-wrapper">
            <div class="row">
                <div class="col-md-12 col-12">
                    <img src="{{asset('public/images/advertise.png')}}">
                </div>
                <div class="col-md-12 col-12">
                    <img src="{{asset('public/images/advertise-2.png')}}" width="250" height="250">
                </div>
            </div>
        </div>
    </div>
